        ...
        >
          ...
          >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="border-2 border-white text-white font-bold py-4 px-8 rounded-lg hover:bg-white hover:text-[#073995] transition-all duration-300 flex items-center space-x-2"
            >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-white/80 text-sm mb-3">Llámanos directamente</p>
                  <a 
                    href="tel:+56949651758" 
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-white/80 text-sm mb-3">Escríbenos un mensaje</p>
                  <a 
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-white/80 text-sm mb-3">Visítanos en nuestras oficinas</p>
                  <p className="text-white font-bold text-sm">
                    Pérez Valenzuela 1098<br />
            ...
            >
              <p className="text-white/70 text-sm">
                Horarios de atención: Lunes a Viernes 9:00 - 18:00 | Sábados 9:00 - 14:00
              </p>
            </motion.div>
          </motion.div>
        </motion.div>

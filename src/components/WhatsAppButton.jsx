    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <AnimatePresence>
            {isHovered && (
              <motion.div
                ...
                className="absolute right-full top-1/2 -translate-y-1/2 mr-4 bg-neutral-900 text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap shadow-lg"
              >
                <span className="font-medium">Agenda tu evaluación</span>
          ...
          {/* Notification Badge (optional - se puede activar para mostrar notificaciones) */}
          {/* 
          <motion.div
